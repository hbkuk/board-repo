...
<script type="text/javascript">
	window.onload = function() {
		document.getElementById( "wbtn" ).onclick = function() {
        	...
        	const fileArray = document.wfrm.upload.value.trim().split('.');
        	
        	if( fileArray[fileArray.length - 1] != 'jpg' && fileArray[fileArray.length - 1] != 'png') {
        		alert('jpg 파일로 업로드해 주세요.');
	        	return false;
        	}
		...
		<!--게시판-->
			...
			<div class="btn_area">
				...
				<div class="align_right">			
					<input id= "wbtn" type="button" value="쓰기" class="btn_write btn_txt01" style="cursor: pointer;" />					
				</div>	
			</div>	
			<!--//게시판-->
		</div>
