...
<%
	...
	String content = to.getContent() == null ? "" : to.getContent().replace("\n", "<br>");
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th>이미지</th>
					<td colspan="3">
						기존 이미지 : <%=filename %>(<%=filesize %>)<br /><br />
			...
			<div class="btn_area">
				<div class="align_left">			
					...
					<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='board_view.do?seq=<%=seq %>&cpage=<%=cpage %>'" />
				</div>
				<div class="align_right">			
					<input id="mbtn" type="button" value="수정" class="btn_write btn_txt01" style="cursor: pointer;" />
				</div>		
			</div>	
			<!--//게시판-->
		</div>
