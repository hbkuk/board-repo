	...
	StringBuilder sbHtml = new StringBuilder();
		...
		for( BoardTO to : boardLists ) {
			...
			if( rowCount == 1) {
				...
				sbHtml.append(" 							<a href='./board_view.do?seq=" + seq +"&cpage=" + cpage +"'><img src='./upload/" + filename +"' border='0' width='100%' /></a>");
				sbHtml.append(" 						</div>");																		
				sbHtml.append(" 					</td>");
				sbHtml.append(" 				</tr>");
				sbHtml.append(" 				<tr>");
...
<div class="contents1"> 
	...
	<div class="contents_sub">	
		<div class="board_top">
			<div class="bold">
				<p>총 <span class="txt_orange"><%=boardLists.size() %></span>건의 게시물</p>
			</div>
		</div>	
...
<%
	...
	if( startBlock == 1) {
		...
		out.println("<span><a href= 'board_list.do?cpage=" + (startBlock - blockPerPage) + "'>&lt;&lt;</a></span>");
	}
	out.println("&nbsp;");
	...
	if( cpage == 1) {
		...
		out.println( "<span><a href='board_list.do?cpage=" + ( cpage - 1) + "'>&lt;</a></span>" );
	}
		out.println( "&nbsp;&nbsp;");
	...
	for	( int i = startBlock; i <= endBlock; i++ ) {
		if( cpage == i) {
			...
			out.println( "<span><a href='board_list.do?cpage=" + i + "'>" + i + "</a></span>" );
		}
	}
	...
	if( cpage == totalPage) {
		...
		out.println( "&nbsp;&nbsp;<span><a href='board_list.do?cpage=" + ( cpage + 1) + "'>&gt</a></span>" );
	}
	
	if( endBlock == totalPage  ) {
		out.println( "<span><a>&gt;&gt;</a></span>");
	} else {
		out.println( "<span><a href='board_list.do?cpage=" + (startBlock + blockPerPage) +"'>&gt&gt</a></span>" );
