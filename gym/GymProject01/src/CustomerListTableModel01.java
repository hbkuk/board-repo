...
public class CustomerListTableModel01 extends AbstractTableModel {
	...
	public CustomerListTableModel01(String cname) {
		// TODO Auto-generated constructor stub
		CustomerListDAO dao = new CustomerListDAO();
		customers = dao.searchCustomers( cname );
	}
	
	public CustomerListTableModel01(int csex) {
		// TODO Auto-generated constructor stub
		CustomerListDAO dao = new CustomerListDAO();
		customers = dao.searchSexCustomers( csex );
	}
